...
object Dependencies {
    ...
    const val RECYCLE_VIEW =
        "androidx.recyclerview:recyclerview:${DependenciesVersions.RECYCLE_VIEW}"
    ...
    const val SHIMMER = "com.facebook.shimmer:shimmer:${DependenciesVersions.SHIMMER}"
    const val SWIPE_REFRESH_LAYOUT =
        "androidx.swiperefreshlayout:swiperefreshlayout:${DependenciesVersions.SWIPE_REFRESH_LAYOUT}"
